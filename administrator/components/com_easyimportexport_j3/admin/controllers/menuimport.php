...
class EasyimportexportControllerMenuimport extends JControllerLegacy
{
    public function import()
    {
        ...
        $file = $app->input->files->get('import_file_menus', null, 'raw');
        ...
        $overwrite = $app->input->getInt('import_overwrite_menus', 0);
