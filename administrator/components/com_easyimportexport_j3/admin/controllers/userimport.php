...
class EasyimportexportControllerUserimport extends JControllerLegacy
{
    public function import()
    {
        ...
        $file = $app->input->files->get('import_file_users', null, 'raw');
        ...
        $overwrite = $app->input->getInt('import_overwrite_users', 0);
