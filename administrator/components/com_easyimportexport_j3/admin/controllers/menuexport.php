...
class EasyimportexportControllerMenuexport extends JControllerLegacy
{
    public function export()
    {
        ...
        if (empty($cid)) {
            $app->enqueueMessage(JText::_('COM_EASYIMPORTEXPORT_MENU_NO_SELECTED'), 'warning');
            $this->setRedirect(JRoute::_('index.php?option=com_easyimportexport&view=modules&tab=menus', false));
    ...
    public function exportAll()
    {
        ...
        $this->sendJson($app, $exportData, 'joomla_menus_export_all_' . date('Y-m-d_His') . '.json');
    }
